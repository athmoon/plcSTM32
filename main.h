...
static  uint16_t tim1,tim2,tim3,tim4;
static  uint16_t val_tim1,val_tim2,val_tim3,val_tim4;
...
//**********  variabili di conteggio luci ****************

static uint8_t cl;  // valore corrente di conteggio in T7 ogni 0,1mSec
//static uint8_t as11,as21,as31,as41,as12,as22,as32,as42;
#define  DT  10                  // durata impulso

static uint16_t tempo_ciclo,tempo_cometa;
static float_t aux_sl;   // per calcolo set durante le rampe
static __IO bool OnOff;
...
{ 
  ...
  RampaTramonto,    // T_3 
  Tramonto,         // T_4  
  RampaNotte,       // T_5 T_1 T_3 
  Notte,            // T_6  + cometa
  RampaGiornoNotte,  // T_5  T_1 
  offSequenza
